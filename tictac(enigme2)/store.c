...
/**
 * function Initializes all images necessary for the store of the game.
...
/**
 * function Prints the whole store on screen.
 *struct store s structure necessary to print
 */
...
/**
 * function Responsable for managing all tics.
...
/**
 * fucntion Responsable for printing the whole store screen.
 *struct tics t all the images and surfaces necessary to print.
 * return tics structure filled with all data necessary.
 */
...
/**
 * function controls the store mouse clicks.
...
/**
 * function This function manages all items that were bought and manages tics 
 */
