...
default : break;
	...
	if(event.button.button == SDL_BUTTON_LEFT )
           {
if((event.button.x>positionyes.x)&&(event.button.x<positionyes.x+positionyes.w)&&(event.button.y>positionyes.y)&&(event.button.y <positionyes.y+positionyes.h))
		{
...
else if ((event.button.x > positionno.x) && (event.button.x < positionno.x + positionno.w) && (event.button.y > positionno.y) && (event.button.y < positionno.y + positionno.h))
	{cont=0;}
